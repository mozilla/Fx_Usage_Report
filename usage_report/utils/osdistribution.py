...
def os_on_date(data, date, country_list, period=7):
    """ Gets the distribution of OS usage calculated on the WAU on 1 day.
        ...
        country_list - The countries to do the analysis. If None then it does
                       it for the whole world.
        period - The number of days to calculate the distibution. By default
                 it finds os distribution over a week.
       """
